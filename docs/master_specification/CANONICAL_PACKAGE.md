...
| Document | Scope |
|----------|-------|
| `AI_MARKETING_AGENT_ROADMAP.md` | PHASE 71–76: AI media, video generation, content writing, social publishing, analytics, growth agent. Full spec with principles, phase dependencies, privacy rules, and implementation gate. |
