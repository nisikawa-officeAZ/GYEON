...
├── ENTERPRISE_RESERVATION_STORE_LOGISTICS_ARCHITECTURE.md ← Canonical design (mandatory future): multi-company/multi-store hierarchy, store business calendar + GBP sync, capacity-based reservation/time-axis philosophy, service scheduling, reservation config wizard, AI recommendations (advisory), flexible B2B ordering, trade-customer closing billing, architecture principles (cross-refs §7.13.1, §7.14.1–§7.14.5, 05 §5.11.1)
