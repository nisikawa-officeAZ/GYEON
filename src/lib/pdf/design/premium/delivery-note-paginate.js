/* TEMPLATE-C2-DN — delivery-note pagination. Byte-derived from the accepted production
 * estimate-paginate.js (DOM-measurement pagination, fonts.ready gate, no URL params, no fixed
 * capacities). The estimate-single-page-fit / estimate-pagination-ready class names are the
 * SHARED contract used by the vendored CSS and the Chromium renderer ready-gate. */
(() => {
