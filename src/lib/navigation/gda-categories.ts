...
export const GDA_CATEGORIES: readonly GdaCategory[] = [
  ...
  { id: "customers", label: "顧客・車両", labelEn: "CUSTOMERS", href: "/customers", icon: "customers", paths: ["/customers", "/vehicles", "/customer-app"], feature: "customers" },
  { id: "estimates", label: "見積・作業", labelEn: "ESTIMATES", href: "/estimates", icon: "document", paths: ["/estimates", "/work-orders", "/completion-reports", "/maintenance"], feature: "estimates" },
  { id: "reservations", label: "予約", labelEn: "RESERVATIONS", href: "/reservations", icon: "calendar", paths: ["/reservations", "/calendar"], feature: "reservations" },
  ...
  { id: "orders", label: "発注・在庫", labelEn: "ORDERS", href: "/product-orders", icon: "orders", paths: ["/product-orders", "/products", "/inventory"], feature: "products" },
  { id: "social-media", label: "SNS", labelEn: "SOCIAL MEDIA", href: null, icon: "social", paths: ["/social-media"] },
  { id: "messages", label: "メッセージ", labelEn: "MESSAGES", href: "/line", icon: "message", paths: ["/line", "/news"], feature: "line", badge: "news" },
  { id: "records", label: "記録・資料", labelEn: "RECORDS", href: "/downloads", icon: "records", paths: ["/downloads", "/pdf", "/ocr-sessions"] },
