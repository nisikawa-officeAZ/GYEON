// Approved static content from GYEON_Certificates_Package v3.0.3.
// Dynamic customer, vehicle, issuer, serial, date and product values are overlaid by the renderer.
...
export const approvedCoatingCertificateContent: CertificateDocumentData = {
  kind: "coating",
...
export const approvedPpfCertificateContent: CertificateDocumentData = {
  kind: "ppf",
...
export const approvedCancoatCertificateContent: CertificateDocumentData = {
  kind: "cancoat",
