...
export const initialEstimateWizardDraftV22: EstimateWizardDraftV22 = {
  ...
  serviceConfiguration: {
    ...
    windowFilm: { selectedAreaIds: [], filmTypeId: null, unitPriceInput: "", selectedPackageCode: null, selectedOptionIds: [], optionQuantities: {} },
  ...
  review: { previewConfirmed: false, serviceLineOrder: [], quantityInputsByLine: {}, unitPriceInputsByLine: {} },
