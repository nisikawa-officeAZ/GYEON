...
export const DEFERRED_FIELD_CONTRACT: readonly FieldContractEntry[] = [
  ...
  { ewUiField: "coupons",                 canonical: "discountAndCoupon.selectedCouponIds", dto: "coupon.selectedCouponIds", db: null, status: "CONTROLLER_PHASE", note: "multiple coupons: product support APPROVED; EW-DC-1 pure monetary contract exists (computeDiscountCouponPricing). Operational binding + persistence remain a future phase; NOT operational yet (still carried as intent; blocked from pricing/persistence by existing gates)." },
  { ewUiField: "discountMode",            canonical: "discountAndCoupon.mode", dto: "discount.intent.mode", db: null, status: "CONTROLLER_PHASE", note: "canonical DiscountMode now explicitly supports none/amount/percent as ONE shared union (screens/step-types.ts) — ready for controller binding. Operational pricing via EW-DC-1 is a future phase." },
  ...
  { ewUiField: "discountPercent",         canonical: "discountAndCoupon.percentInput", dto: "discount.intent.percentage", db: null, status: "CONTROLLER_PHASE", note: "percentage: product support APPROVED; EW-DC-1 pure monetary contract exists. Operational binding + persistence remain a future phase; NOT operational yet (still forwarded as intent and blocked by the adapter/save gates)." },
