...
export const DEFERRED_FIELD_CONTRACT: readonly FieldContractEntry[] = [
  ...
  { ewUiField: "services",                canonical: null, dto: null, db: null, status: "DISPLAY_ONLY_UNTIL_TYPED_CONTRACT", note: "loose Record<string,unknown>; MUST NOT map into canonical serviceConfiguration until a typed Screen-4 contract exists. A non-empty services patch fails closed." },
