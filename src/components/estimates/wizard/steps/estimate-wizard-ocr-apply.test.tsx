// GDA-2A-OCR-R1 — mounted proof that ONE reviewed OCR result reflects both customer and vehicle
// draft fields (plus the transient 3M recommendation) through ONE combined api.updateStore call,
// and that Step 1 and Step 2 share the same typed vehicle mapper.
//
...
import { updateNewVehicle } from "../draft/wizard-draft-state";
...
// ── Exactly seven size keys, no forbidden eighth size, anywhere in the OCR-unification source ──
//
