...
export default function EstimatesError({
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4 py-10 text-slate-100">
      <div role="alert" className="w-full max-w-lg text-center">
        <h1 className="text-xl font-bold text-slate-100 mb-3">見積画面でエラーが発生しました</h1>
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          {reset ? (
            <button
              type="button"
              onClick={reset}
              className="rounded-md border border-slate-600 bg-slate-800 px-5 py-2.5 text-sm text-slate-100 hover:bg-slate-700"
            >
              もう一度試す
            </button>
          ) : null}
